...
final class Cadmium extends Atom
{
    private int $atomicNumber = 48;
    private string $symbol = 'Cd'; 
    private float $atomicWeight = 112.411;
    private mixed $electronegativity = 1.69;
