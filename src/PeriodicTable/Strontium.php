...
final class Strontium extends Atom
{
    private int $atomicNumber = 38;
    private string $symbol = 'Sr'; 
    private float $atomicWeight = 87.620;
    private mixed $electronegativity = 0.95;
