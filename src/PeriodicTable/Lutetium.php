...
final class Lutetium extends Atom
{
    private int $atomicNumber = 71;
    private string $symbol = 'Lu'; 
    private float $atomicWeight = 174.967;
    private mixed $electronegativity = 1.27;
