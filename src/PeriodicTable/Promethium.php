...
final class Promethium extends Atom
{
    private int $atomicNumber = 61;
    private string $symbol = 'Pm'; 
    private float $atomicWeight = 145.000;
    private mixed $electronegativity = 0.00;
