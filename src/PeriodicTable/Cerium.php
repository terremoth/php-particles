...
final class Cerium extends Atom
{
    private int $atomicNumber = 58;
    private string $symbol = 'Ce'; 
    private float $atomicWeight = 140.116;
    private mixed $electronegativity = 1.12;
