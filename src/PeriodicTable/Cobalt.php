...
final class Cobalt extends Atom
{
    private int $atomicNumber = 27;
    private string $symbol = 'Co'; 
    private float $atomicWeight = 58.933;
    private mixed $electronegativity = 1.88;
