...
final class Beryllium extends Atom
{
    private int $atomicNumber = 4;
    private string $symbol = 'Be'; 
    private float $atomicWeight = 9.012;
    private mixed $electronegativity = 1.57;
