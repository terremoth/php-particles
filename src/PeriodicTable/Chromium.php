...
final class Chromium extends Atom
{
    private int $atomicNumber = 24;
    private string $symbol = 'Cr'; 
    private float $atomicWeight = 51.996;
    private mixed $electronegativity = 1.66;
