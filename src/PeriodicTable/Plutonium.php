...
final class Plutonium extends Atom
{
    private int $atomicNumber = 94;
    private string $symbol = 'Pu'; 
    private float $atomicWeight = 244.000;
    private mixed $electronegativity = 1.28;
