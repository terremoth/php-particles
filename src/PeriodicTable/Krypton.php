...
final class Krypton extends Atom
{
    private int $atomicNumber = 36;
    private string $symbol = 'Kr'; 
    private float $atomicWeight = 83.800;
    private mixed $electronegativity = 3.00;
