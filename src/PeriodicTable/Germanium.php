...
final class Germanium extends Atom
{
    private int $atomicNumber = 32;
    private string $symbol = 'Ge'; 
    private float $atomicWeight = 72.640;
    private mixed $electronegativity = 2.01;
