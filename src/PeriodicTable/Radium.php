...
final class Radium extends Atom
{
    private int $atomicNumber = 88;
    private string $symbol = 'Ra'; 
    private float $atomicWeight = 226.000;
    private mixed $electronegativity = 0.90;
