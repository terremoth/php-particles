...
final class Praseodymium extends Atom
{
    private int $atomicNumber = 59;
    private string $symbol = 'Pr'; 
    private float $atomicWeight = 140.908;
    private mixed $electronegativity = 1.13;
