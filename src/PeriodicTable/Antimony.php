...
final class Antimony extends Atom
{
    private int $atomicNumber = 51;
    private string $symbol = 'Sb'; 
    private float $atomicWeight = 121.760;
    private mixed $electronegativity = 2.05;
