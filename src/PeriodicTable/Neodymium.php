...
final class Neodymium extends Atom
{
    private int $atomicNumber = 60;
    private string $symbol = 'Nd'; 
    private float $atomicWeight = 144.240;
    private mixed $electronegativity = 1.14;
