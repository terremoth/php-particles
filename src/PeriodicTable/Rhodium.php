...
final class Rhodium extends Atom
{
    private int $atomicNumber = 45;
    private string $symbol = 'Rh'; 
    private float $atomicWeight = 102.906;
    private mixed $electronegativity = 2.28;
