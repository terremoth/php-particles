...
final class Bismuth extends Atom
{
    private int $atomicNumber = 83;
    private string $symbol = 'Bi'; 
    private float $atomicWeight = 208.980;
    private mixed $electronegativity = 2.02;
