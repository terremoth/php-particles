...
final class Erbium extends Atom
{
    private int $atomicNumber = 68;
    private string $symbol = 'Er'; 
    private float $atomicWeight = 167.259;
    private mixed $electronegativity = 1.24;
