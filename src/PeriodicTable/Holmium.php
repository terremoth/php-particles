...
final class Holmium extends Atom
{
    private int $atomicNumber = 67;
    private string $symbol = 'Ho'; 
    private float $atomicWeight = 164.930;
    private mixed $electronegativity = 1.23;
