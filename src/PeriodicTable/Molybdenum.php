...
final class Molybdenum extends Atom
{
    private int $atomicNumber = 42;
    private string $symbol = 'Mo'; 
    private float $atomicWeight = 95.940;
    private mixed $electronegativity = 2.16;
