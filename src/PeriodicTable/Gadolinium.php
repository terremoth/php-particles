...
final class Gadolinium extends Atom
{
    private int $atomicNumber = 64;
    private string $symbol = 'Gd'; 
    private float $atomicWeight = 157.250;
    private mixed $electronegativity = 1.20;
