...
final class Xenon extends Atom
{
    private int $atomicNumber = 54;
    private string $symbol = 'Xe'; 
    private float $atomicWeight = 131.293;
    private mixed $electronegativity = 2.60;
