...
final class Lead extends Atom
{
    private int $atomicNumber = 82;
    private string $symbol = 'Pb'; 
    private float $atomicWeight = 207.200;
    private mixed $electronegativity = 2.33;
