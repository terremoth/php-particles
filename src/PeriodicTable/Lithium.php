...
final class Lithium extends Atom
{
    private int $atomicNumber = 3;
    private string $symbol = 'Li'; 
    private float $atomicWeight = 6.941;
    private mixed $electronegativity = 0.98;
