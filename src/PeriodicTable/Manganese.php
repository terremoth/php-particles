...
final class Manganese extends Atom
{
    private int $atomicNumber = 25;
    private string $symbol = 'Mn'; 
    private float $atomicWeight = 54.938;
    private mixed $electronegativity = 1.55;
