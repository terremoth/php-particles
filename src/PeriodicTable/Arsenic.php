...
final class Arsenic extends Atom
{
    private int $atomicNumber = 33;
    private string $symbol = 'As'; 
    private float $atomicWeight = 74.922;
    private mixed $electronegativity = 2.18;
