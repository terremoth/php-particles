...
final class Titanium extends Atom
{
    private int $atomicNumber = 22;
    private string $symbol = 'Ti'; 
    private float $atomicWeight = 47.867;
    private mixed $electronegativity = 1.54;
