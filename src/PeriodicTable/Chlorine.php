...
final class Chlorine extends Atom
{
    private int $atomicNumber = 17;
    private string $symbol = 'Cl'; 
    private float $atomicWeight = 35.453;
    private mixed $electronegativity = 3.16;
