...
final class Nickel extends Atom
{
    private int $atomicNumber = 28;
    private string $symbol = 'Ni'; 
    private float $atomicWeight = 58.693;
    private mixed $electronegativity = 1.91;
