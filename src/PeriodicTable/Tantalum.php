...
final class Tantalum extends Atom
{
    private int $atomicNumber = 73;
    private string $symbol = 'Ta'; 
    private float $atomicWeight = 180.948;
    private mixed $electronegativity = 1.50;
