...
final class Zirconium extends Atom
{
    private int $atomicNumber = 40;
    private string $symbol = 'Zr'; 
    private float $atomicWeight = 91.224;
    private mixed $electronegativity = 1.33;
