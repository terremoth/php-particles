...
final class Calcium extends Atom
{
    private int $atomicNumber = 20;
    private string $symbol = 'Ca'; 
    private float $atomicWeight = 40.078;
    private mixed $electronegativity = 1.00;
