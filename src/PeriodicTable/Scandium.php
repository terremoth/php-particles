...
final class Scandium extends Atom
{
    private int $atomicNumber = 21;
    private string $symbol = 'Sc'; 
    private float $atomicWeight = 44.956;
    private mixed $electronegativity = 1.36;
