...
final class Californium extends Atom
{
    private int $atomicNumber = 98;
    private string $symbol = 'Cf'; 
    private float $atomicWeight = 251.000;
    private mixed $electronegativity = 1.30;
